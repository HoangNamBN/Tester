...
<head>
    ...
    <link rel="shortcut icon" href="../Image/dodadung.ico" type="image/x-icon">
    <link rel="icon" href="../Image/dodadung.ico" type="image/x-icon">
    ...
    <title>Đăng Nhập - Website Đồ Da Dụng Nhật Cao Cấp </title>
</head>

<body>
    <div class="Phan1">
        <div class="Phan1Trai">
            <img src="../Image/dodadung.jpg" alt="">
            <p style="color:black;">Đồ da dụng Nhật cao cấp</p>
        </div>
        <div class="Phan1Phai">
    ...
    <div class="Login">
        ...
        if(empty($_POST['name']) or empty($_POST['password'])){
            ...
            if(strlen($name) < 5){
                ...
                <strong>Lỗi!</strong> tài khoản của bạn nhập quá ngắn </div>';
            }
            else if(strlen($name) > 30){
                echo '<div class="alert alert-warning">
                <strong>Lỗi!</strong> tài khoản của bạn nhập quá dài  </div>';
            }
            else{
                if($num_row!=0)
                {
