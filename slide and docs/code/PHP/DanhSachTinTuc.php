    ...
    <div class="container" style="margin-top: 20px;margin-left:5px;">
        <div class="row">
            ...
            <div class="col-md-2"><a href="Add_Edit_TinTuc.php" class="btn btn-danger" role="button"
                    style="margin-left:700px;width:157px;height:40px;padding-bottom:20px;background:#f86c6b">Thêm Tin Tức</a></div>
        </div>
                  ...
                  $current_page = isset($_GET['page']) ? $_GET['page'] : 1;
                    ...
                    foreach($result as $std){
                      echo '<tr style=" text-align: center;">
                        <td >'.$std['MaTinTuc'].'</td>
                        <td><img src="../Image/'.$std['AnhTinTuc'].'" style="width:310px;height:100px"></td>
                        <td>'.$std['TenTinTuc'].'</td>
                        <td style="width:120px;">'.$std['TenDMTT'].'</td>
                        <td >'.$std['MoTa'].'</td>
                        <td>'.$std['ChiTiet'].'</td>
