...
<head>
    ...
    <link rel="shortcut icon" href="../Image/dodadung.jpg" type="image/x-icon">
    <link rel="icon" href="../Image/dodadung.jpg" type="image/x-icon">
    ...
    <title>Đăng Ký - Website Đồ Da Dụng Nhật Cao Cấp</title>
</head>
